...
import com.ecomm.sciproapplication.views.teacher.fragment.courses.components.CreateCourseDialogFragment
...
class CoursesFragment : Fragment() {
    ...
    private val filePickerLauncher = registerForActivityResult(
        ...
        Toast.makeText(requireContext(), "Course Uri: $fileUri", Toast.LENGTH_SHORT).show()
        pdfImageUri.value = fileUri
    }
    ...
    val Uri: Uri? = null
    var pdfImageUri = mutableStateOf(Uri)
    ...
    private fun ShowCourseView(viewModel: CoursesViewModel, onBackPressed: () -> Unit) {
        ...
        Scaffold(
            ...
            content = {
                ...
                CreateCourseDialogFragment(
                    openDialog = openDialog.value,
                    pdfImageUri = pdfImageUri.value,
                    filePickerLauncher,
                    onDismissRequest = {
    ...
    private fun CourseTopbar(viewModel: CoursesViewModel, onBackPressed: () -> Unit) {
        TopAppBar(
            title = {
                Text(
                    text = viewModel.programEntity.programTitle,
                    style = TextStyle(color = Color.Red)
                )
            },
            navigationIcon = {
